<%@ Page Title="Iniciar sesión" Language="C#" MasterPageFile="~/Anonimo.master" AutoEventWireup="true"
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p>
        ...
        <span id="spnErrorLogin" runat="server" class="failureNotification">
   ...
   <%-- <asp:Login ID="LoginUser" runat="server" EnableViewState="false" RenderOuterTable="false">
        <LayoutTemplate>
            ...
            <div class="accountInfo">
                ...
                <p class="submitButton">
                    <asp:Button ID="LoginButton" OnClick="LoginButton_Click" runat="server" CommandName="Login" Text="Iniciar sesión" ValidationGroup="LoginUserValidationGroup"/>
                </p>
            </div>
        </LayoutTemplate>
    </asp:Login>--%>
